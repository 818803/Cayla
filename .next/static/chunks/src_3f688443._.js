...
function ChatPage() {
    ...
    const [initialMessages, setInitialMessages] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(undefined);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ChatPage.useEffect": ()=>{
            if (!params.sessionId) return;
            const conversation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$conversation$2d$history$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getConversation"])(params.sessionId);
            if (conversation && Array.isArray(conversation.messages)) {
                const formattedMessages = conversation.messages.map({
                    "ChatPage.useEffect.formattedMessages": (m)=>({
                            id: m.id,
                            role: m.role,
                            content: m.content
                        })
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(ChatComponent, {
...
_s(ChatPage, "FhZgwyDRz41GEMRXJuihT5m6ixw=", false, function() {
    return [
...
function ChatComponent({ sessionId, initialMessages }) {
    ...
    const { messages, input, handleInputChange, handleSubmit, isLoading, error, setMessages } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$ai$2f$react$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useChat"])({
        ...
        initialMessages: initialMessages,
        onResponse: {
            "ChatComponent.useChat": (response)=>{
        ...
        onFinish: {
            "ChatComponent.useChat": (message)=>{
                ...
                const updatedMessages = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$conversation$2d$history$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getConversation"])(sessionId)?.messages ?? initialMessages;
                const finalMessages = [
                    ...updatedMessages,
                    message
                ];
                const conversationTitle = finalMessages.find({
                    "ChatComponent.useChat": (m)=>m.role === 'user'
                }["ChatComponent.useChat"])?.content.substring(0, 30) || 'New Chat';
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$conversation$2d$history$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["saveConversation"])(sessionId, conversationTitle, finalMessages);
                if (finalMessages.filter({
                    "ChatComponent.useChat": (m)=>m.role === 'user'
                }["ChatComponent.useChat"]).length === 1) {
                    window.dispatchEvent(new Event('conversationHistoryChanged'));
                }
            }
        }["ChatComponent.useChat"],
        onError: {
            "ChatComponent.useChat": (err)=>{
                try {
...
_s1(ChatComponent, "2sjP8TeDhhMQOj0UF37BJCLYtSY=", false, function() {
    return [
...
//# sourceMappingURL=src_3f688443._.js.map