...
async function getClassifier() {
    if (classifier === null) {
        try {
            ...
            classifier = await (0, __TURBOPACK__imported__module__$5b$externals$5d2f40$huggingface$2f$transformers__$5b$external$5d$__$2840$huggingface$2f$transformers$2c$__esm_import$29$__["pipeline"])('text-classification', 'bhadresh-savani/distilbert-base-uncased-emotion');
        } catch (error) {
...
async function detectEmotion(text) {
    ...
    try {
        ...
        if (typeof emotionClassifier === 'function') {
            result = await emotionClassifier(text, {
                top_k: 1
            });
        } else {
...
function ChatPage({ params }) {
    ...
    const [isHistoryLoaded, setIsHistoryLoaded] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(false);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
    ...
    const { messages, input, handleInputChange, handleSubmit, isLoading, error } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$ai$2f$react$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useChat"])({
        ...
        onFinish: (message)=>{
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$conversation$2d$history$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["saveConversation"])(params.sessionId, conversationTitle, messages);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b4c8da17._.js.map